...
(function () {
  ...
  var dict = {
    fr: {
      ...
      "section.about.rows.0.text": "Étudiant en informatique à Conakry, je construis des projets web et j’apprends en développant, en testant et en déployant des interfaces réelles.",
      ...
      "section.contact.channels.email": "GitHub",
      "section.contact.channels.formulaire": "Formulaire",
      "section.contact.channels.whatsapp.value": "+224 628 016 9479",
      "section.contact.channels.email.value": "github.com/sudomarc",
      ...
      "case.interact.context": "Projet réalisé pour l’Interact de ma ville afin de présenter le club et renforcer sa visibilité.",
      "case.interact.problem": "Donner au club une présence web claire expliquant son identité, ses activités et ses moyens de contact.",
      "case.interact.constraint": "Ordinateur personnel aux performances limitées pour le développement.",
      "case.interact.constraint2": "Accès limité aux modèles IA avancés faute d’abonnement.",
      "case.interact.decision": "Construire une interface claire et accessible, avec la présentation du club et la visibilité comme priorités.",
      "case.interact.solution": "Conception, développement, tests et déploiement réalisés de bout en bout par moi.",
      /* case body — crazycook */
      ...
      "privacy.contact.text": "Pour contacter le responsable du site, utiliser le GitHub public : github.com/sudomarc",
      /* cookies */
    ...
    en: {
      ...
      /* case body — interact-conakry */
      "case.interact.context": "Project built for the Interact club in my city to present the club and improve its visibility.",
      "case.interact.problem": "Give the club a clear web presence explaining who it is, what it does and how to get in touch.",
      "case.interact.constraint": "A personal computer with limited development performance.",
      "case.interact.constraint2": "Limited access to advanced AI models because of subscription constraints.",
      "case.interact.decision": "Keep the interface clear and accessible, with club presentation and visibility as the priorities.",
      "case.interact.solution": "I handled the design, development, testing and deployment end to end.",
      /* case body — crazycook */
